...
<?php 
// 조회처리.
$query = "SELECT site_name, site_url FROM tbl_sitemap_dev_ko WHERE `ctg_code` = '01'";
...
<?php 
// 조회처리.
$query = "SELECT site_name, site_url FROM tbl_sitemap_dev_ko WHERE ctg_code = '02'";
$result = mysql_query($query);
if($result) {
	while($row = mysql_fetch_array($result, MYSQL_ASSOC)) {
	$siteName = $row['site_name'];
...
<?php 
// 조회처리.
$query = "SELECT site_name, site_url FROM tbl_sitemap_dev_ko WHERE ctg_code = '03'";
$result = mysql_query($query);
if($result) {
	while($row = mysql_fetch_array($result, MYSQL_ASSOC)) {
	$siteName = $row['site_name'];
...
<?php 
// 조회처리.
$query = "SELECT site_name, site_url FROM tbl_sitemap_dev_ko WHERE ctg_code = '04'";
$result = mysql_query($query);
if($result) {
	while($row = mysql_fetch_array($result, MYSQL_ASSOC)) {
	$siteName = $row['site_name'];
...
<?php 
// 조회처리.
$query = "SELECT site_name, site_url FROM tbl_sitemap_dev_ko WHERE ctg_code = '05'";
$result = mysql_query($query);
if($result) {
	while($row = mysql_fetch_array($result, MYSQL_ASSOC)) {
	$siteName = $row['site_name'];
...
<?php 
// 조회처리.
$query = "SELECT site_name, site_url FROM tbl_sitemap_dev_ko WHERE ctg_code = '06'";
$result = mysql_query($query);
if($result) {
	while($row = mysql_fetch_array($result, MYSQL_ASSOC)) {
	$siteName = $row['site_name'];
...
<?php 
// 조회처리.
$query = "SELECT site_name, site_url FROM tbl_sitemap_dev_ko WHERE ctg_code = '07'";
$result = mysql_query($query);
if($result) {
	while($row = mysql_fetch_array($result, MYSQL_ASSOC)) {
	$siteName = $row['site_name'];
...
<?php 
// 조회처리.
$query = "SELECT site_name, site_url FROM tbl_sitemap_dev_ko WHERE ctg_code = '08'";
$result = mysql_query($query);
if($result) {
	while($row = mysql_fetch_array($result, MYSQL_ASSOC)) {
	$siteName = $row['site_name'];
...
<?php 
// 조회처리.
$query = "SELECT site_name, site_url FROM tbl_sitemap_dev_ko WHERE ctg_code = '09'";
$result = mysql_query($query);
if($result) {
	while($row = mysql_fetch_array($result, MYSQL_ASSOC)) {
	$siteName = $row['site_name'];
...
<?php 
// 조회처리.
$query = "SELECT site_name, site_url FROM tbl_sitemap_dev_ko WHERE ctg_code = '10'";
$result = mysql_query($query);
if($result) {
	while($row = mysql_fetch_array($result, MYSQL_ASSOC)) {
	$siteName = $row['site_name'];
...
<?php 
// 조회처리.
$query = "SELECT site_name, site_url FROM tbl_sitemap_dev_ko WHERE ctg_code = '11'";
$result = mysql_query($query);
if($result) {
	while($row = mysql_fetch_array($result, MYSQL_ASSOC)) {
	$siteName = $row['site_name'];
...
<?php 
// 조회처리.
$query = "SELECT site_name, site_url FROM tbl_sitemap_dev_ko WHERE ctg_code = '12'";
$result = mysql_query($query);
if($result) {
	while($row = mysql_fetch_array($result, MYSQL_ASSOC)) {
	$siteName = $row['site_name'];
...
<?php 
// 조회처리.
$query = "SELECT site_name, site_url FROM tbl_sitemap_dev_ko WHERE ctg_code = '13'";
$result = mysql_query($query);
if($result) {
	while($row = mysql_fetch_array($result, MYSQL_ASSOC)) {
	$siteName = $row['site_name'];
...
<?php 
// 조회처리.
$query = "SELECT site_name, site_url FROM tbl_sitemap_dev_ko WHERE ctg_code = '14'";
$result = mysql_query($query);
if($result) {
	while($row = mysql_fetch_array($result, MYSQL_ASSOC)) {
	$siteName = $row['site_name'];
...
<?php 
// 조회처리.
$query = "SELECT site_name, site_url FROM tbl_sitemap_dev_ko WHERE ctg_code = '15'";
$result = mysql_query($query);
if($result) {
	while($row = mysql_fetch_array($result, MYSQL_ASSOC)) {
	$siteName = $row['site_name'];
...
<?php 
// 조회처리.
$query = "SELECT site_name, site_url FROM tbl_sitemap_dev_ko WHERE ctg_code = '16'";
$result = mysql_query($query);
if($result) {
	while($row = mysql_fetch_array($result, MYSQL_ASSOC)) {
	$siteName = $row['site_name'];
...
<?php 
// 조회처리.
$query = "SELECT site_name, site_url FROM tbl_sitemap_dev_ko WHERE ctg_code = '17'";
$result = mysql_query($query);
if($result) {
	while($row = mysql_fetch_array($result, MYSQL_ASSOC)) {
	$siteName = $row['site_name'];
...
<?php 
// 조회처리.
$query = "SELECT site_name, site_url FROM tbl_sitemap_dev_ko WHERE ctg_code = '18'";
$result = mysql_query($query);
if($result) {
	while($row = mysql_fetch_array($result, MYSQL_ASSOC)) {
	$siteName = $row['site_name'];
...
<?php 
// 조회처리.
$query = "SELECT site_name, site_url FROM tbl_sitemap_dev_ko WHERE ctg_code = '19'";
$result = mysql_query($query);
if($result) {
	while($row = mysql_fetch_array($result, MYSQL_ASSOC)) {
	$siteName = $row['site_name'];
...
<?php 
// 조회처리.
$query = "SELECT site_name, site_url FROM tbl_sitemap_dev_ko WHERE ctg_code = '20'";
$result = mysql_query($query);
if($result) {
	while($row = mysql_fetch_array($result, MYSQL_ASSOC)) {
	$siteName = $row['site_name'];
...
<?php 
// 조회처리.
$query = "SELECT site_name, site_url FROM tbl_sitemap_dev_ko WHERE ctg_code = '21'";
$result = mysql_query($query);
if($result) {
	while($row = mysql_fetch_array($result, MYSQL_ASSOC)) {
	$siteName = $row['site_name'];
...
<?php 
// 조회처리.
$query = "SELECT site_name, site_url FROM tbl_sitemap_dev_ko WHERE ctg_code = '22'";
$result = mysql_query($query);
if($result) {
	while($row = mysql_fetch_array($result, MYSQL_ASSOC)) {
	$siteName = $row['site_name'];
...
<?php 
// 조회처리.
$query = "SELECT site_name, site_url FROM tbl_sitemap_dev_ko WHERE ctg_code = '23'";
$result = mysql_query($query);
if($result) {
	while($row = mysql_fetch_array($result, MYSQL_ASSOC)) {
	$siteName = $row['site_name'];
...
<?php 
// 조회처리.
$query = "SELECT site_name, site_url FROM tbl_sitemap_dev_ko WHERE ctg_code = '24'";
$result = mysql_query($query);
if($result) {
	while($row = mysql_fetch_array($result, MYSQL_ASSOC)) {
	$siteName = $row['site_name'];
